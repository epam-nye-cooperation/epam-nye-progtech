...
import hu.nye.progtech.sudoku.conduct.Conductor;
...
public class Main {
    ...
    public static void main(String[] args) throws GridWriteException, InvalidGridException, GridReadException {
        ...
        new Conductor(persister).conduct();
