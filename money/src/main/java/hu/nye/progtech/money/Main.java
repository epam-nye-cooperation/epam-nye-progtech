...
import hu.nye.progtech.money.bank.ExchangeService;
import hu.nye.progtech.money.bank.StaticBank;
import hu.nye.progtech.money.comparator.MoneyComparator;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        StaticBank staticBank = new StaticBank(new ExchangeService());
